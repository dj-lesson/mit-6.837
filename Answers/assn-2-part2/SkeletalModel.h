...
private:
	...
	void drawSkeletonHelper(Joint*,Vector4f);
	void computeBindWorldToJointTransformsHelper(Joint*,Matrix4f);
	void updateCurrentJointToWorldTransformsHelper(Joint*, Matrix4f);
};
